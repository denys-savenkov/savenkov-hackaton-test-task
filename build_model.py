...
from keras.layers import Lambda, Conv2D, MaxPooling2D, Dropout, Conv2DTranspose, concatenate

from dice_loss import dice_loss, dice_coef


def build_unet(image_height, image_width, image_channels):
    start_neurons = 16
